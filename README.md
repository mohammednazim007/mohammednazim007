...
✨ 𝕀’𝕞 𝕔𝕦𝕣𝕣𝕖𝕟𝕥𝕝𝕪 𝕨𝕠𝕣𝕜𝕚𝕟𝕘 𝕠𝕟:<br>Building responsive web applications using React, Next, TypeScript, and modern CSS frameworks like Tailwind CSS.<br>Improving performance optimization for web applications using tools like Lighthouse and Web Vitals.<br><br>🧑‍🤝‍🧑 I’m looking to collaborate on:<br>Open-source projects involving frontend frameworks like React or Next.<br><br>
